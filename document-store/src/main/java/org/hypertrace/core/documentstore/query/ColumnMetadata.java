...
public class ColumnMetadata {
  ...
  @Singular Map<String, String> columns; // column_name -> type_string

  // Known native array type suffixes (from entity-service ValueType)
  private static final Set<String> NATIVE_ARRAY_TYPES =
      Set.of("STRING_ARRAY", "LONG_ARRAY", "DOUBLE_ARRAY", "BOOLEAN_ARRAY");

  // Known native scalar types (from entity-service ValueType)
  private static final Set<String> NATIVE_SCALAR_TYPES =
      Set.of("STRING", "LONG", "DOUBLE", "BYTES", "BOOL", "TIMESTAMP");

  // Known JSONB types (from entity-service ValueType)
  private static final Set<String> JSONB_TYPES = Set.of("STRING_MAP");
